...
{ orderNo: 2, pno: 2, orderDate: '2023-12-24', count: 2, totalPrice: 30000 },
...
function 매출() {
    ...
    for (let e = 0; e < dayArray.length; e++) {
        ...
        <td>${dayArray[e].daySales.toLocaleString()+'원'}</td> 
        </tr>`
        }
...
function 총매출액(){
    let info = JSON.parse(localStorage.getItem('orderArray'));
